...
private var destinationsStub: Set<Destination> = [
    .init(
        id: "217",
        name: "Barbade",
    ...
    .init(
        id: "6",
        name: "Allemagne",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/1027397_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 5
    ),
    .init(
        id: "306",
        name: "Bali",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/1581674_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        id: "13",
        name: "Autriche",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/354894_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 5
    ),
    .init(
        id: "147",
        name: "Antilles",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/397848_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        ...
        picture: URL(string: "https://static1.evcdn.net/images/reduction/1596154_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        id: "73",
        name: "Afrique du Sud",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/1506493_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 5
    ),
    .init(
        id: "98",
        name: "Australie",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/635304_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        ...
        picture: URL(string: "https://static1.evcdn.net/images/reduction/1595441_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        id: "377",
        name: "Bajio",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/1596170_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        id: "74",
        name: "Azerbaïdjan",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/611704_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 5
    ),
    .init(
        id: "115",
        name: "Antarctique",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/210925_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        id: "110",
        name: "Bangladesh",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/356979_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        id: "29",
        name: "Algérie",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/1230836_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 5
    ),
    .init(
        id: "75",
        name: "Argentine",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/904030_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 5
    ),
    .init(
        id: "173",
        name: "Açores",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/356685_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
        id: "170",
        name: "Albanie",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/413980_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 4
    ),
    .init(
    ...
    .init(
        id: "107",
        name: "Bahamas",
        picture: URL(string: "https://static1.evcdn.net/images/reduction/39034_w-800_h-800_q-70_m-crop.jpg")!,
        tag: "Incontournable",
        rating: 5
    )
]

private var destinationDetailsStub: Set<DestinationDetails> = [
